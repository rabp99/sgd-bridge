...
class SignatureController extends Controller
{
    ...
    public function signCargoInternoProveido(Request $request) 
    {
        $path = storage_path('app/private/fwAuthorization.json');
        ...
        $queryParams = "id=$id&signatureReason=" . urlencode($signatureReason) . "&role=" . urlencode($role);

        $documentTosignURL = env('SGD_CLIENT_PDF_INTERNO_PROVEIDO_URL') . '?id=' . $id;
        $uploadURL = env('SGD_CLIENT_PDF_UPLOADER_CARGO_INTERNO_PROVEIDO_URL') . '?' . $queryParams;
        $imageToStampURL = env('SGD_CLIENT_IMAGE_TO_STAMP');
